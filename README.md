...
Sentience is a mobile wallet that provides easy access to websites that use the [Ethereum](https://ethereum.org/) blockchain.
...
-   Install the Android SDK, via [Android Studio](https://developer.android.com/studio).
    -   Sentience Only:_ To create production builds, you need to install Google Play Licensing Library via the SDK Manager in Android Studio.
...
### Important constant need to be copied

- After the setup 
- copy this below contants code:
```
        "use strict";
    ...
    background: {
        sheet: '#0A0B0B',//'#24272A',
        default: '#060204',//'#000000',//'#24272A', //black
        defaultHover: '#E2ADBF',//'#282B2E',
        defaultPressed: '#E2ADBF',//'#36383B',
        alternative: '#E2ADBF',//'#141618',
        alternativeHover: '#E2ADBF',//'#191B1D',
        alternativePressed: '#E2ADBF',//'#27292A',
        hover: '#E2ADBF',//'#FFFFFF05',
        pressed: '#E2ADBF',//'#FFFFFF14',
    },
    text: {
        new: '#E98FCD',
        default: '#FFFFFF',
...
```
- go to file locations and replace the codes
    1. node_module>@metamask>design-tokens>dist>js>themes>lightTheme>colors.js
    2. node_module>@metamask>design-tokens>dist>js>themes>darkTheme>colors.js